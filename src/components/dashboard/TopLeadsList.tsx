...
export function TopLeadsList({ cards }: { cards: PipelineCard[] }) {
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      <h2 className="mb-1 text-sm font-semibold text-gray-900">Top Potential Leads</h2>
      <p className="mb-3 text-xs text-gray-400">Hot lead & stage terjauh diutamakan</p>
      {cards.length === 0 ? (
        <p className="py-8 text-center text-sm text-gray-400">Belum ada leads.</p>
      ) : (
